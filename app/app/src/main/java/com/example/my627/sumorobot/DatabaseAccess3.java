 ...
 */
public class DatabaseAccess3 extends AsyncTask<Void, Void, String> {
    ...
    public DatabaseAccess3(Context ctx, URL url, String teamname ) {
        this.context = ctx;
        this.url = url;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    .appendQueryParameter("inputTeamname", teamname);
    ...
    protected void onPostExecute(String result) {
        if (anydata == "yes") {
           ...
           Intent intent = new Intent(context, team_members.class);
            context.startActivity(intent);
            //Toast.makeText(context, "Nothing there.", Toast.LENGTH_LONG).show();
        }
    }

 ...
 */
public class DatabaseAccess6 extends AsyncTask<Void, Void, String> {
    ...
    public DatabaseAccess6(Context ctx, URL url, String email, String nTeamname, String nAddress, String nCity, String nState, String nZip ) {
        this.context = ctx;
        this.url = url;
        this.email = email;
    ...
    protected String doInBackground(Void... params) {
        ...
        try {
            ...
            Uri.Builder builder = new Uri.Builder()
                    ...
                    .appendQueryParameter("inputTeamname", nTeamname)
                    .appendQueryParameter("inputAddress", nAddress)
                    .appendQueryParameter("inputCity", nCity)
                    .appendQueryParameter("inputState", nState)
                    .appendQueryParameter("inputZip", nZip);
    ...
    protected void onPostExecute(String result) {
        if (anydata == "yes") {
          ...
          /*  Intent intent = new Intent(context, team_members.class);
            context.startActivity(intent);*/
            Toast.makeText(context, "Wasn't Created.", Toast.LENGTH_LONG).show();
        }
    }
